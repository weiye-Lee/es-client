...
export default [
  ...
  },
  {
    ...
    items: [{
      ...
      content: "优化JSON解析与JSON格式化算法，解决了double类型和long类型变为了string类型"
    }, {
      label: LogItemEnum.UPDATE,
      content: "「高级查询」优化了高级查询格式化算法和语法解析算法"
    }, {
      label: LogItemEnum.UPDATE,
      content: "「查询」track_total_hits增强，自动识别es版本，小于7的版本不会增加track_total_hits，可在全局设置中设置"
    }, {
      label: LogItemEnum.UPDATE,
      content: "「系统」查询索引列表去除 stat，增强系统的健壮性"
    }, {
      label: LogItemEnum.ADD,
      content: "「基础查询」新增查询类型match_phrase"
    }]
  },
  {
    version: '3.1.8',
